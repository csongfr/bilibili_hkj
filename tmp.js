      ...
      if (tpModel) {
        $("a[href*='/video/av']").click(function(event) {
          ...
          return $z.load(_bilibili_url + "/video/av877489/ .z:first", function() {
			...
			$(".fav_btn_top", $z).attr("onclick", $(".fav_btn_top", $z).attr("onclick").replace("877489", _params[2]));
			$(".fav a:last").attr("href", $(".fav a:last", $z).attr("href").replace("877489", _params[2]));
			$(".fav a:last").attr("onclick", $(".fav a:last", $z).attr("onclick").replace("877489", _params[2]));
            $(".ad-f", $z).remove();
            $(".ad-e1", $z).remove();
            $(".ad-e2", $z).remove();
            $(".ad-e3", $z).remove();
